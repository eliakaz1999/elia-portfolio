      ...
      <motion.div style={{ marginBottom: '3rem' }} {...fade(4)}>
        ...
        <div style={{ borderTop: '1px solid var(--border)' }}>
          {[
            ...
            <div key={row.label} className="cv-skills-row" style={{ display: 'grid', gridTemplateColumns: 'minmax(120px, 200px) 1fr', gap: '1.25rem', alignItems: 'start', padding: '0.9rem 0', borderBottom: '1px solid var(--border)', transition: 'background 0.15s' }}
